...
public class OrderPage {
    ...
    private final By addressInput = By.xpath(".//div[starts-with(@class, 'Order_Form')]//input[contains(@placeholder,'Адрес: куда привезти заказ')]");
    ...
    private final By phoneInput = By.xpath(".//div[starts-with(@class, 'Order_Form')]//input[contains(@placeholder,'Телефон: на него позвонит курьер')]");
    ...
    // Конструктор класса OrderPage. Создает новый экземпляр образа страницы заказа @param webDriver веб-драйвер
    ...
    // Метод для ожидания загрузки элемента страницы @param elementToLoad элемент, ожидающий загрузки
    ...
    // Метод для установки значения в поле "Имя" @param name вводимое значение
    public void setName(String name) {
        this.webDriver.findElement(this.nameInput).sendKeys(name);
    }

    // Метод для установки значения в поле "Фамилия" @param surname вводимое значение
    public void setSurname(String surname) {
        this.webDriver.findElement(this.surnameInput).sendKeys(surname);
    }

    // Метод для установки значения в поле "Адрес: куда привезти заказ" @param address вводимое значение
    public void setAddress(String address) {
        this.webDriver.findElement(this.addressInput).sendKeys(address);
    }

    // Метод для установки значения в поле "Станция метро" @param metro вводимое значение
    ...
    // Метод для установки значения в поле "Телефон" @param phone вводимое значение
    ...
    // Метод для установки значения в поле "Когда привезут самокат" @param date вводимое значение
    ...
    // Метод для установки значения в поле "Срок аренды" @param termToChoose вводимое значение
    ...
    //Метод для установки значения в поле "Цвет" @param colorToChoose вводимое значение
    public void setColor(String colorToChoose) {
        this.chooseElementFromDropdown(this.colorLabels, colorToChoose);
    }

    // Метод для установки значения в поле "Комментарий для курьера" @param comment вводимое значение
    ...
    // Метод для получения сообщения об успешном оформлении заказа @return сообщение о заказе
    ...
    // Метод для выбора элемента выпадающего списка @param dropdownElements элемент страницы с данными из выпадающего списка @param elementToChoose элемент, который необходимо выбрать
    ...
    // Метод для раскрытия списка срока аренды
