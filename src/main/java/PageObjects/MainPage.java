...
public class MainPage {
    ...
    //Конструктор класса MainPage. Создает новый экземпляр образа главной страницы @param driver веб-драйвер
    public MainPage(WebDriver driver) {
        this.webDriver = driver;
    }

    // Метод для ожидания загрузки элемента аккордеона @param index порядковый номер элемента аккордеона
    ...
    // Метод для получения текста на заголовке блока в аккордеоне @param index порядковый номер элемента аккордеона @return текст из заголовка
    public String getAccordionHeaderText(int index) {
        return this.webDriver.findElements(this.accordionHeaders).get(index).getText();
    }

    // Метод для получения текста из раскрывающегося блока в аккордеоне @param index порядковый номер элемента аккордеона @return текст из раскрывающегося блока
    public String getAccordionItemText(int index) {
        return this.webDriver.findElements(this.accordionItems).get(index).getText();
    }

    // Метод для нажатия на заголовок блока в аккордеоне @param index порядковый номер элемента аккордеона
    public void clickAccordionHeader(int index) {
        this.webDriver.findElements(this.accordionHeaders).get(index).click();
    }

    // Метод для проверки раскрытия блока аккордеона @param index порядковый номер элемента аккордеона @return флаг раскрытия
