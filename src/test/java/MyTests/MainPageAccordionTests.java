...
public class MainPageAccordionTests {
    ...
    // Конструктор класса MainPageAccordionTests @param numberOfAccordionItem Порядковый номер элемента аккордеона @param expectedHeaderText Ожидаемый текст в заголовке элемента аккордеона @param expectedItemText Ожидаемый текст в раскрывающемся блоке элемента аккордеона
    ...
    // Параметризация теста @return массив параметров
